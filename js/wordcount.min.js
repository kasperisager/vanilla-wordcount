...
!function(t,a){"use strict";a.WordCount=a.WordCount||function(a){this.options={textarea:".js-text-box",wrapper:".js-text-box-wrapper",classes:{wrap:"badge-wrap",badge:"badge",label:"badge-label"}},a&&(a.counters=a.counters||[],t.extend(!0,this.options,a))},WordCount.prototype.buildCounter=function(a,e){if(a.length){var n=this.options.classes,o=e.labels,r=t("<p>").addClass(n.wrap);return r.$badge=t("<span>").addClass(n.badge),r.$label=t("<span>").addClass(n.label),r.html(r.$badge.add(r.$label)),a.on("input",function(){Countable.once(a[0],function(t){var a=e.counter(t);r.$badge.text(a),r.$label.text(o[1===a?"singular":"plural"])})}).trigger("input"),r}},WordCount.prototype.attachCounters=function(t,a){if(!t.data("counters")){var e=t.val();setInterval(function(){t.val()!==e&&(t.trigger("input"),e=t.val())},100);for(var n=this.options.counters.length-1;n>=0;n--)a.after(this.buildCounter(t,this.options.counters[n]));t.data("counters",!0)}},WordCount.prototype.attachCountersHandler=function(){var a=this,e=t(this.options.wrapper);e.each(function(){var e=t(this),n=t(a.options.textarea,e);a.attachCounters(n,e)})}}(jQuery,window,document);
!function(r,e,a){"use strict";r(function(){var e=r.parseJSON(gdn.definition("WordCount")),n={textarea:".TextBox",wrapper:".TextBoxWrapper",classes:{wrap:"Count-Wrap",badge:"Count",label:"Count-Label"},counters:[{labels:{singular:e.labels.character,plural:e.labels.characters},counter:function(r){return e.max-r.characters}},{labels:{singular:e.labels.word,plural:e.labels.words},counter:function(r){return r.words}}]},t=["ready","EditCommentFormLoaded"],o=new WordCount(n);r(a).on(t.join(" "),o.attachCountersHandler.bind(o))})}(jQuery,window,document);